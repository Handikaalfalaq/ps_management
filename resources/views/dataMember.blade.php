                ...
                <div class="bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="p-5">
                        <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Handika Al Falaq</a>
                        </h3>
                        <span class="text-gray-500 dark:text-gray-400">082186693767 || laki laki</span>
                        <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">jalan padat karya no 09 rejosari.</p>
